...
subroutine fabric_ortosynth(trend, plunge, anglemin, anglemax, npts, &
    ...
    ! FABRIC_ORTOSYNTH computes the euler angles of a fabric from its 
    ! statistical description trend, plunge, anglemin and anglemax. Angles are 
    ! input as degrees. The number of points (npts) corresponds to the number of 
    ! equal sized grains. The outputs are written to the specified file as comma 
    ! delimited text.
    !
    ! INPUTS
    !	trend (float)
